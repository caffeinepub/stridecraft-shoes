...
export class Backend implements backendInterface {
    ...
    async getFilteredProducts(arg0: string | null, arg1: bigint | null, arg2: bigint | null, arg3: boolean | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilteredProducts(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n3(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitForm(arg0: string, arg1: string, arg2: string): Promise<SubmissionId> {
        if (this.processError) {
            try {
